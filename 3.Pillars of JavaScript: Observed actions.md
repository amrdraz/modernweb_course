...
![](3.Pillars%20of%20JavaScript:%20Observed%20actions/3.1.png)
...
In our model of application design we render the entire application programatically like this
...
Since we are rendering strings by attaching them into the innerHTML attribute of our element’s DOM Node, can not select the element and add events to it. We can however have the event call functions we define.
